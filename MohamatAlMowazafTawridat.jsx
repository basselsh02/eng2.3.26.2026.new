...
export default function MohamatAlMowazafTawridat() {
  return (
    <div className="p-4 space-y-4" dir="rtl">
      <div className="flex items-center justify-between flex-wrap gap-2">
        ...
        <div className="flex-1 flex justify-center">
          <h1 className="text-xl font-bold bg-primary-500 text-white px-8 py-2 rounded">مهام الموظف - مكتب التوريدات</h1>
        </div>
        <div className="flex flex-col gap-2">
          <button className="border border-gray-300 rounded px-3 py-1 text-sm bg-base hover:bg-primary-50">قسم التوريدات</button>
      ...
      <div className="bg-base border border-gray-200 rounded p-8 text-center text-gray-400">
        <p className="text-lg">صفحة مهام الموظف</p>
      </div>
    </div>
  );
}
