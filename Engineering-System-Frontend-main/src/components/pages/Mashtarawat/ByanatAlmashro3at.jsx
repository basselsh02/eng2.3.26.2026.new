...
const tabs = ["المشروع", "شروط المشروع", "ترشيح الشركات", "أصناف المشروع", "طباعة المذكرات"];
...
const shorotData = [
  { id: 1, kod: "343", ismNaw3Shart: "طريقة التعاقد", mosalsal: "99", wasf: "المناقصة المحدودة", tartib: "3", qima: "1000" },
  { id: 2, kod: "3", ismNaw3Shart: "قيمة التأمين المؤقت", mosalsal: "3", wasf: "جنية", tartib: "4", qima: "5000" },
  { id: 3, kod: "232", ismNaw3Shart: "نمن كراسة الشروط", mosalsal: "4", wasf: "جنية", tartib: "5", qima: "200" },
  { id: 4, kod: "17", ismNaw3Shart: "تم التعاقد بالمناقصة المحدودة", mosalsal: "92", wasf: "طبقاً للمادة 57 من القانون وتلك الاعتبارات الامن القومى وعدم توافر الوقت", tartib: "6", qima: "300" },
  { id: 5, kod: "214", ismNaw3Shart: "النشر", mosalsal: "17", wasf: "على الشركات المرشحة ذات الخبرة والسمعة الطيبة والمصداق عليها من الجواز", tartib: "7", qima: "250" },
  { id: 6, kod: "240", ismNaw3Shart: "محل الطارج", mosalsal: "90", wasf: "ادارة الاشغال العسكرية", tartib: "8", qima: "8887" },
];
    ...
    <div className="space-y-3" dir="rtl">
      <div className="flex items-center gap-2 flex-wrap text-sm">
        <div className="flex items-center gap-2">
          ...
          <input defaultValue="5444" className="border border-gray-300 rounded px-2 py-1 bg-background w-32" />
        </div>
      ...
      <div className="flex gap-2 flex-wrap">
        <Button size="sm" variant="primary">تحميل شروط النشر</Button>
    ...
    <div className="space-y-3" dir="rtl">
      <div className="flex items-center gap-3 flex-wrap text-sm">
        ...
        <div className="flex items-center gap-2 flex-1">
          ...
          <input
            defaultValue="توريد اصناف لزوم مركز تدريب المنشاة النموذجي"
            className="flex-1 border border-gray-300 rounded px-2 py-1 bg-background min-w-40"
          />
        </div>
      </div>
...
export default function ByanatAlmashro3at() {
  ...
  const renderTabContent = () => {
    switch (activeTab) {
      ...
      case "أصناف المشروع": return <AsnafSection />;
    ...
    <div className="p-4 space-y-4" dir="rtl">
      ...
      <div className="flex items-center justify-between flex-wrap gap-2">
        ...
        <div className="flex-1 flex justify-center">
          <h1 className="text-xl font-bold bg-primary-500 text-white px-8 py-2 rounded">بيانات المشروعات</h1>
        </div>
        <div className="flex flex-col gap-2">
